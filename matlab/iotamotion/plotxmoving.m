...
%     The struct of essential parameters. See input_params.m for more information
    ...
    for i = 1:2
        ...
        grid on
        title("Iotamotion Device Test " +string(idx.carrier)+" Carrier Effects "+string(error_unit{i})+" Error on y = "+string(input_param.y_axis(1)))
...
%   The struct of essential parameters. See input_params.m for more information
    ...
    grid on
    title("Iotamotion Device Test " +string(idx.carrier)+" Carrier Effects Coupling Magnitude on y = "+string(input_param.y_axis(1)))
