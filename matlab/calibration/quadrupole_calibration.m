...
hr_calibration.d_source_pos = hr_cal.source_pos; 
hr_calibration.d_source_moment = hr_cal.source_moment; 
hr_calibration.d_sensor_pos = hr_cal.sensor_pos; 
hr_calibration.d_sensor_moment = hr_cal.sensor_moment; 
