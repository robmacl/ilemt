...
all_directory = {
    ...
    'D:\ilemt_interfere_data\output_file\October Y=0 90 degree',...
    'D:\ilemt_interfere_data\output_file\October X=20',...
...
input_plot = {{"ilemt", "HighLow", 0, "skip", false},...
    ...
    {"Guidance", "xmoving", 90, "skip", false},...
    {"Guidance", "ymoving", 0, "skip", false},...
