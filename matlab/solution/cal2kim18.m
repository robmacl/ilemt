...
% matrix is our coupling matrix, divided by coupling_gains, then transposed.
% Use these coupling_gains to normalize the measurement in the same way that
% we have normalized the sensor moments:
